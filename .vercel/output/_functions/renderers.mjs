...
function emitProviderConfiguredEvent(eventProvider, isViewProvider = false) {
  throwError("Injector profiler should never be called in production mode");
  if (typeof eventProvider === "function") ; else if (eventProvider instanceof InjectionToken) ; else {
    resolveForwardRef(eventProvider.provide);
  }
  if (eventProvider instanceof InjectionToken) {
    eventProvider.ɵprov || eventProvider;
  }
  injectorProfiler({
...
class R3Injector extends EnvironmentInjector {
  ...
  hydrate(token, record) {
    const prevConsumer = setActiveConsumer(null);
    try {
      if (false) ; else if (record.value === NOT_YET) {
...
let SharedStylesHost = /* @__PURE__ */ (() => {
  class SharedStylesHost2 {
    ...
    static ɵfac = function SharedStylesHost_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || SharedStylesHost2)(ɵɵinject(DOCUMENT), ɵɵinject(APP_ID), ɵɵinject(CSP_NONCE, 8), ɵɵinject(PLATFORM_ID));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let DomRendererFactory2 = /* @__PURE__ */ (() => {
  class DomRendererFactory22 {
    ...
    static ɵfac = function DomRendererFactory2_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || DomRendererFactory22)(ɵɵinject(EventManager), ɵɵinject(SharedStylesHost), ɵɵinject(APP_ID), ɵɵinject(REMOVE_STYLES_ON_COMPONENT_DESTROY), ɵɵinject(DOCUMENT), ɵɵinject(PLATFORM_ID), ɵɵinject(NgZone), ɵɵinject(CSP_NONCE), ɵɵinject(TracingService, 8));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let DomEventsPlugin = /* @__PURE__ */ (() => {
  class DomEventsPlugin2 extends EventManagerPlugin {
    ...
    static ɵfac = function DomEventsPlugin_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || DomEventsPlugin2)(ɵɵinject(DOCUMENT));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let KeyEventsPlugin = /* @__PURE__ */ (() => {
  class KeyEventsPlugin2 extends EventManagerPlugin {
    ...
    static ɵfac = function KeyEventsPlugin_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || KeyEventsPlugin2)(ɵɵinject(DOCUMENT));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let NoopAnimationDriver = /* @__PURE__ */ (() => {
  class NoopAnimationDriver2 {
    ...
    static ɵfac = function NoopAnimationDriver_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || NoopAnimationDriver2)();
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let InjectableAnimationEngine = /* @__PURE__ */ (() => {
  class InjectableAnimationEngine2 extends AnimationEngine {
    ...
    static ɵfac = function InjectableAnimationEngine_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || InjectableAnimationEngine2)(ɵɵinject(DOCUMENT), ɵɵinject(AnimationDriver), ɵɵinject(AnimationStyleNormalizer));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
  ...
  class DominoAdapter2 extends BrowserDomAdapter {
    ...
    getDefaultDocument() {
      if (!DominoAdapter2.defaultDoc) {
        DominoAdapter2.defaultDoc = domino.createDocument();
      }
...
let PlatformState = /* @__PURE__ */ (() => {
  class PlatformState2 {
    ...
    static ɵfac = function PlatformState_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || PlatformState2)(ɵɵinject(DOCUMENT));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let ServerPlatformLocation = /* @__PURE__ */ (() => {
  class ServerPlatformLocation2 {
    ...
    static ɵfac = function ServerPlatformLocation_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || ServerPlatformLocation2)(ɵɵinject(DOCUMENT), ɵɵinject(INITIAL_CONFIG, 8));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
...
let ServerEventManagerPlugin = /* @__PURE__ */ (() => {
  class ServerEventManagerPlugin2 extends EventManagerPlugin {
    ...
    static ɵfac = function ServerEventManagerPlugin_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || ServerEventManagerPlugin2)(ɵɵinject(DOCUMENT));
    };
    static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
